...
class ExMobileViT(nn.Module):
    def __init__(self, image_size, dims, channels, num_classes, expansion=4, kernel_size=3, patch_size=(2, 2)):
        ...
        self.conv2_1 = conv_1x1_bn(channels[-6], int(channels[-6] / 3))
        self.conv2_2 = conv_1x1_bn(channels[-4], int(channels[-4] * 1))
        self.conv2   = conv_1x1_bn(channels[-2], int(channels[-2] * 3))
